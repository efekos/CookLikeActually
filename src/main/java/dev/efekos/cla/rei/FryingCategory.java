...
public class FryingCategory implements DisplayCategory<FryingDisplay> {

    public static final Identifier ID = Identifier.of(Main.MOD_ID,"frying");
    public static final CategoryIdentifier<FryingDisplay> CATEGORY_ID = CategoryIdentifier.of(ID);

    @Override
    public CategoryIdentifier<? extends FryingDisplay> getCategoryIdentifier() {
        return CATEGORY_ID;
    }
    ...
    @Override
    public List<Widget> setupDisplay(FryingDisplay display, Rectangle bounds) {
