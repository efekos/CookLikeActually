...
public class PottingCategory implements DisplayCategory<ArrowProgressDisplay> {

    public static final Identifier ID = Identifier.of(Main.MOD_ID, "potting");
    ...
    public Text getTitle() {
        return Text.translatable("category.cla.potting");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(ClaBlocks.POT);
    }
