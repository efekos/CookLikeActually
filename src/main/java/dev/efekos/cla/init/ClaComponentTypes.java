...
public class ClaComponentTypes {
    ...
    public static final ComponentType<Integer> OIL_CLEANNESS = register("oil_cleanness",builder->builder.codec(Codecs.NONNEGATIVE_INT).packetCodec(PacketCodecs.VAR_INT));
